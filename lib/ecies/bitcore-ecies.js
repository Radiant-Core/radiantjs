...
ECIES.prototype.decrypt = function (encbuf) {
  ...
  // Constant-time MAC compare: short-circuit equality leaks the position of
  // the first byte mismatch on attacker-controlled ciphertext.
  if (!FixedTime.areEqual(d, d2)) {
