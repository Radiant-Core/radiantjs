...
ECIES.prototype.decrypt = function (encbuf) {
  ...
  // Constant-time MAC compare. Buffer.equals() short-circuits on first
  // mismatch and leaks timing on attacker-controlled ciphertext.
  if (!FixedTime.areEqual(hmac, hmac2)) {
