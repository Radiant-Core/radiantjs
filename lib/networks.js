...
// Network magic bytes from Radiant-Core/src/chainparams.cpp (netMagic):
//   mainnet  e3 e1 f3 e8     (CChainParams::Main)
//   testnet  matches Bitcoin testnet for compatibility with test infrastructure
//   regtest  matches Bitcoin regtest
// Ports, seeds and address prefixes follow Radiant-Core chainparams.cpp.
var networkMagic = {
  livenet: 0xe3e1f3e8,
  testnet: 0xf4e5f3f4,
  regtest: 0xdab5bffa,
  // STN retained for API back-compat; Radiant-Core has no STN chain.
  stn: 0xfbcec4f9
}
...
// DEPRECATED: Radiant has no Stress Test Network. The STN constants survive
// only to keep the historical enableStn()/disableStn() API non-throwing for
// consumers built against pre-2.0.4 radiantjs. New code should not rely on it.
var STN = {
  PORT: 9333,
  NETWORK_MAGIC: networkMagic.stn,
  DNS_SEEDS: [],
  PREFIX: 'stn',
  CASHADDRPREFIX: 'radstn'
}
