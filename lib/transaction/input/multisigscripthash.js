...
MultiSigScriptHashInput.prototype._estimateSize = function () {
  ...
  // Up to 16 keys (m, n) fit in a single OP_n opcode (3 bytes total: m/n/CHECKMULTISIG).
  // Above 16, each count becomes a PUSHDATA1 of 1 byte (3 bytes total), adding 2 bytes
  // each. Without this correction the estimate under-budgets fee for n>16 multisigs.
  var redeemScriptSize = 3 + pubKeysSize
  if (this.publicKeys.length > 16) redeemScriptSize += 2
  if (this.threshold > 16) redeemScriptSize += 2
