...
// 546 photons mirrors the conventional Bitcoin / Bitcoin Cash floor and is
// safe under Radiant relay policy (which derives per-output dust from the
// dustRelayFee × output size; 546 covers a typical P2PKH output even at
// elevated fee rates). Set Transaction.DUST_AMOUNT lower at your own risk.
...
// Value used for fee estimation (photons per kilobyte).
// Post-V2 mainnet relay floor is 10,000 photons/byte = 10,000,000 photons/KB.
Transaction.FEE_PER_KB = 10000000

// Minimum fee rate at which mainnet relays will accept a transaction. Building
// below this value produces a transaction the network will reject. Kept as a
// separate constant so callers can knowingly set a lower rate for testing.
Transaction.MIN_RELAY_FEE_PER_KB = 10000000
