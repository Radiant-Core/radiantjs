...
// Self-contained invariants (were `assert(...)`): no load-order dependency on
// the module-scope `assert` import — see the note in hdprivatekey.js.
