...
// Mask of bits the v2 envelope flags byte actually uses. Bits 3-6 are reserved
// and MUST be zero per Whitepaper §7.3; encoder masks them off, decoder
// rejects envelopes that set them.
const ENVELOPE_FLAGS_MASK =
  EnvelopeFlags.HAS_CONTENT_ROOT |
  EnvelopeFlags.HAS_CONTROLLER |
  EnvelopeFlags.HAS_PROFILE_HINT |
  EnvelopeFlags.IS_REVEAL
